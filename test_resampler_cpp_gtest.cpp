...
// Test fixture for IQ Resampler C++ implementation tests
class IQResamplerCPPTest : public ::testing::Test {
protected:
...
TEST_F(IQResamplerCPPTest, Initialization) {
    EXPECT_NO_THROW({
...
TEST_F(IQResamplerCPPTest, OutputSizeCorrect) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
TEST_F(IQResamplerCPPTest, Rate120kTo100k) {
...
TEST_F(IQResamplerCPPTest, PowerPreservation) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
TEST_F(IQResamplerCPPTest, DCSignalPreservation) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
TEST_F(IQResamplerCPPTest, FrequencyPreservation) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
TEST_F(IQResamplerCPPTest, ResetState) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
TEST_F(IQResamplerCPPTest, StreamingMultipleBlocks) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
TEST_F(IQResamplerCPPTest, InvalidInputSize) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
// Test: Empty input
TEST_F(IQResamplerCPPTest, EmptyInput) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
// Test: Small input
TEST_F(IQResamplerCPPTest, SmallInput) {
    IQResamplerCPP resampler(INPUT_RATE, OUTPUT_RATE);
...
TEST_F(IQResamplerCPPTest, DifferentFilterLengths) {
...
TEST_F(IQResamplerCPPTest, VariousRatios) {
    struct TestCase {
        int inputRate;
        int outputRate;
        int inputSamples;
